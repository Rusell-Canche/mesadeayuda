        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center">
                ...
                <div class="sidebar-brand-logo">
                    <img src="assets/mesadeayuda.png" alt="Logo" style="max-width: 100%; height: auto; max-height: 60px;">
                </div>
            </a>
            ...
            <li class="nav-item w-100 my-2">
                <div class="d-flex align-items-center text-muted px-3">
                    <div class="flex-grow-1 border-top"></div>
                    <span class="mx-2 small fw-medium">Tickets</span>
                    <div class="flex-grow-1 border-top"></div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/capturar">
                    <i class="fas fa-plus" style="color: #0fadebff;"></i> <span style="color: #848B96; font-weight: 500;">Nuevo Ticket</span></a>
            </li>
            @endif
            @if(Auth::check() && Auth::user()->hasRole(['administrador', 'lector', 'editor','root']))
            <li class="nav-item">
                <a class="nav-link" href="/consultar">
                    <i class="fas fa-folder-open" style="color: #0fadebff;"></i>
                    <span style="color: #848B96;font-weight: 500;">Consultar Tickets</span></a>
            </li>
            @endif
            ...
            <li class="nav-item w-100 my-2">
                <div class="d-flex align-items-center text-muted px-3">
                    <div class="flex-grow-1 border-top"></div>
                    <span class="mx-2 small fw-medium">Administración</span>
                    <div class="flex-grow-1 border-top"></div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
                    <i class="fas fa-users" style="color: #0fadebff;"></i>
                    <span style="color: #848B96;font-weight: 500;">Usuarios</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/dependencias">
                    <i class="fas fa-city" style="color: #0fadebff;"></i>
                    <span style="color: #848B96;font-weight: 500;">Instituciones</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/departamentos">
                    <i class="fas fa-user-tie" style="color: #0fadebff;"></i>
                    <span style="color: #848B96;font-weight: 500;">Unidad Administrativa</span></a>
            ...
            <li class="nav-item w-100 my-2">
                <div class="d-flex align-items-center text-muted px-3">
                    <div class="flex-grow-1 border-top"></div>
                    <span class="mx-2 small fw-medium">Catalogos</span>
                    <div class="flex-grow-1 border-top"></div>
                </div>
            </li>
            @endif
            ...
            <li class="nav-item">
                <a class="nav-link" href="/cuadro">
                    <i class="fas fa-list" style="color: #0fadebff;"></i>
                    <span style="color: #848B96;font-weight: 500;">Categorias</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/indexfondos">
                    <i class="fas fa-exclamation-triangle" style="color: #0fadebff;"></i>
                    <span style="color: #848B96;font-weight: 500;">Prioridades</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/indexfondos">
                    <i class="fas fa-list" style="color: #0fadebff;"></i>
                    <span style="color: #848B96;font-weight: 500;">Fondos</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/fondos">
                    ...
                    <span style="color: #848B96;font-weight: 500;">Crear Fondos</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/cargarexpedientes">
                    ...
                    <span style="color: #848B96;font-weight: 500;">Cargar expedientes</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/tramite">
                    ...
                    <span style="color: #848B96;font-weight: 500;">En Tramite</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/concentracion">
                    ...
                    <span style="color: #848B96;font-weight: 500;">En Concentraciión</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/historico">
                    ...
                    <span style="color: #848B96;font-weight: 500;">En Historico</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/reportes">
                    ...
                    <span style="color: #848B96;font-weight: 500;">Generar reportes</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/cuadro">
                    ...
                    <span style="color: #848B96;font-weight: 500;">Cuadro General</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/catalogodisposicion">
                    ...
                    <span style="color: #848B96;font-weight: 500;">Catalogo Disposicion</span></a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/bajas">
                    ...
                    <span style="color: #848B96;font-weight: 500;">Bajas</span></a>
